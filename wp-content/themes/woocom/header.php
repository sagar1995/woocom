...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'woocom' ); ?></a>
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			if ( $woocom_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $woocom_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
